...
const SocialLinksProfileModel = () => {
  const buttonClass =
    'bg-gray-500 text-white py-2 px-3 rounded-md mb-2 font-bold text-sm hover:bg-teal-300 hover:text-black';
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center mb-5">
        <img
          src="../../public/images/my_profile.JPG"
          alt="avatar-jessica"
          className="h-28 w-28 object-cover rounded-full mb-3"
        />
      ...
      <div className="flex flex-col">
        ...
        <a
          href="https://www.instagram.com/i_brand_on/"
          target="_blank"
          rel="noopener noreferrer"
          className={buttonClass}
        >
